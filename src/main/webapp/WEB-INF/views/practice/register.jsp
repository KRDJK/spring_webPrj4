            ...
            <div class="offset-md-2 col-md-4">
                <div class="card" style="width:200%;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/practice/register" name="signup" id="signUpForm" method="post"
    ...
    <script>
        $(document).ready(function () {
            ...
            $idInput.on('keyup', e => {
                ...
                else if (!getIdCheck.test($idInput
                        .val())) { // 입력된 값이 getIdCheck의 정규표현식에 맞는지 테스트하겠다는 뜻이다.
                    $idInput.css('border-color', 'red');
                ...
                // 아이디 중복확인
                    ...
                    // 중복확인 비동기 요청
                    fetch('/practice/check?type=id&value=' + $idInput.val())
                        .then(res => res.text()) // 객체가 날아오지 않고 논리값이 날아오기 때문에 text()로 받았다.
                        .then(flag => {
            ...
            $emailInput.on('keyup', function () {
                ...
                //이메일값 유효성검사
                    ...
                    //이메일 중복확인 비동기 통신
                    fetch('/practice/check?type=email&value=' + $emailInput.val())
                        .then(res => res.text())
                        .then(flag => {
                            //console.log(flag);
                            if (flag === 'true') {
