            ...
            <div class="offset-md-2 col-md-4">
                <div class="card" style="width:200%;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/practice/login" name="sign-in" method="post" id="signInForm"
                        ...
                        <table style="cellpadding: 0; cellspacing: 0; margin: 0 auto; width: 100%">
                            ...
                            <tr>
                                <td><input type="text" name="id" id="signInId"
                            ...
                            <tr>
                                <td
                                    ...
                                    <a class="btn form-control tooltipstered" href="/practice/register"
